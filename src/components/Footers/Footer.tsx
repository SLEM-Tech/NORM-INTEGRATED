...
const Footer = () => {
	...
	return (
		<footer className='bg-gray-300 w-full py-2 lg:py-8 flex flex-col item-center'>
			<div className='mx-auto max-w-[1400px] w-full hidden slg:block'>
				<section className='flex justify-center gap-16 mt-2'>
					<div className='flex flex-col gap-4 w-[80%]'>
						...
						<h4 className='text-secondary-500 text-[8px] sm:text-[10px] slg:text-xs font-[400] leading-[1.2]'>
							Copyright&nbsp;@ {currentYear}&nbsp;{CompanyName} Alright
							Reserved.
						</h4>
					</div>
