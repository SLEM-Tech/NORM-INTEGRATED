...
const ProductCard2 = ({
	...
	return (
		<div
			className={`flex flex-col gap-2 justify-center items-center max-w-[150px] min-w-[150px] md:min-w-[180px] slg:min-w-[180px] slg:max-w-[180px] h-[200px] sm:h-[230px] slg:h-[260px] cursor-pointer rounded-sm ${
				boxShadow ? "shadow-lg bg-white" : "border-[1px] border-[#bfbfbf4f]"
			} hover:shadow-lg hover:scale-105 transition`}
		>
			<div className='flex-[.8] mx-auto w-full relative flex justify-center overflow-hidden rounded-t-sm bg-gray-400 p-2 pt-0'>
			...
			<div className='flex-[.2] flex w-full flex-col px-2 pb-1'>
				...
				<div className='flex items-center justify-between'>
					...
					>
						{cartItemCount === 0 ? (
							<div className='bg-secondary-400 p-1 rounded-full'>
								<AiOutlinePlus
